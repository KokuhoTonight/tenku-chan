...
//			gameObject.active = ((Component)parentControl).gameObject.active;
	...
	void DrawGizmosImpl()
	{
		Gizmos.color = new Color(0.5f, 0.5f, 1.0f, 0.8f);
		Gizmos.DrawWireCube(GetStartPos_SingleLine(characterSize, maxWidth)
							+ transform.position + new Vector3(maxWidth/2, -characterSize / 2, 0),
							new Vector3(maxWidth, characterSize, 0));
	}
